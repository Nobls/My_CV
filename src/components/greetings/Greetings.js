        ...
        <div className={styleGreetings.bgColor} id={'home'}>
            <div className={`${style.container} ${styleGreetings.greetings} ${themes ? styleGreetings.dark : styleGreetings.light}`}>
                {lang ?
                    <>
                        <div>
                            <h1 className={styleGreetings.title}>Hello,<br/> I'm Sergei Veretilo a<br/><div className={styleGreetings.changeText} style={{color:'#dc965a'}}>Front - End Developer (React)</div></h1>
                        </div>
                        <div>
                        </div>
